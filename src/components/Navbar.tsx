  ...
  return (
    <div className="fixed top-0 flex justify-center w-full z-50">
      <div className="container">
        <nav className="flex items-center justify-between my-6 mx-4 px-4 py-3 bg-white border border-neutral-100 rounded-full dark:bg-black dark:border-neutral-900">
